const IPFS_GATEWAY = "https://lens.infura-ipfs.io/ipfs/",
  getAvatarUrl = (t) => {
    const e = t.picture.original.url;
    return e
      .replace(/^Qm[1-9A-Za-z]{44}/gm, `${IPFS_GATEWAY}${e}`)
  ...
  openPost = (t) => {
    window.open(`https://lenster.xyz/posts/${t}`, "_blank");
  },
  getPost = (t) => {
