...
const getAvatarUrl = (user) => {
  const hash = user?.picture?.original?.url;
  return hash
...
const openPost = (postId) => {
  window.open(`https://lenster.xyz/posts/${postId}`, "_blank");
};
